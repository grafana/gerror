// Package gerror provides utilities for working with errors in Grafana.
//
...
// service using the [New] constructor with a [CoreStatus] and a
// unique static message ID that identifies the structure of the public
// message attached to the specific error.
//
//	var errNotFound = gerror.New(gerror.StatusNotFound, "service.notFound")
//
...
//
//	var errNotFound = gerror.New(gerror.StatusNotFound "service.notFound", WithPublicMessage("The thing is missing."))
//
